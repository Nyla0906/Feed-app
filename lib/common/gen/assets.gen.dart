...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/detail.svg
  SvgGenImage get detail => const SvgGenImage('assets/icons/detail.svg');
  ...
  /// List of all assets
  List<SvgGenImage> get values => [cancel, detail, favourite, feed, star];
}
